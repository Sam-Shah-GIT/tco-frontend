...
class tco_model:
    ...
    def __init__(self, coating_type="XGIT-Fuel", cleaning_frequency=None, average_power=4000, fuel_type="VLSFO",
                 ...
                 offhire_cost_per_cleaning = 10000,m_modifier = 1,dwt = None, vessel_type = None,distance = None):
    ...
    def load_fuel_details(self, fuel_type):
        ...
        self.fuel_details = pd.read_csv(r"fuel_prices_today.csv")
    ...
    def load_coating_details(self, coating_type):
        ...
        self.coating_details = pd.read_excel(r'coating_details.xlsx', skiprows=5)
...
def cii_table(models, debug=True, save=False,show = True):
    ...
    combined_df.to_csv("CII Results/Tables/cii_table_test.csv")
